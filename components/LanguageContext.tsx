...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    hero_desc: "基于浏览器本地处理，安全高效。集成 Gemini AI 技术，为您提供智能的文档处理体验。无需上传文件到服务器。",
    start_edit: "立即开始编辑",
    popular_tools: "热门工具",
    ...
    convert_desc: "从 PDF 中提取文本和数据为可编辑格式。",
  ...
  en: {
    ...
    hero_desc: "Browser-based, secure, and efficient. Powered by Gemini AI for smart document processing. No file uploads needed.",
    ...
    convert_desc: "Extract text and data from PDF to editable formats.",
  ...
  fr: {
    ...
    hero_desc: "Basé sur navigateur, sécurisé et efficace. Propulsé par Gemini AI pour un traitement intelligent des documents.",
    ...
    convert_desc: "Extraire texte et données vers formats éditables.",
  ...
  es: {
    ...
    hero_desc: "Basado en navegador, seguro y eficiente. Impulsado por Gemini AI para procesamiento inteligente.",
    ...
    convert_title: "Convertir PDF",
    convert_desc: "Extraer texto y datos a formatos editables.",
  ...
  it: {
    ...
    hero_desc: "Basato su browser, sicuro ed efficiente. Potenziato da Gemini AI per l'elaborazione intelligente dei documenti.",
    ...
    convert_desc: "Estrai testo e dati in formati modificabili.",
