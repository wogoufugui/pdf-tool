...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    convert_title: "转换 PDF",
    convert_desc: "PDF 与 Word、Excel 等格式互转。",
    convert_upload_label: "上传要转换的 PDF",
    convert_note: "注意：",
    convert_note_text: "Excel 转换使用 AI 检测表格。结果可能因 PDF 复杂度而异。",
    convert_btn: "开始转换",
    convert_processing: "分析与转换中...",
    ...
    prompt_header: "输入页眉文本：",
    prompt_footer: "输入页脚文本：",
    prompt_text: "输入文本：",
    prompt_link: "输入链接 URL (例如 https://example.com):",
    ...
    convert_mode_pdf_to_file: "PDF 转文件",
    convert_mode_file_to_pdf: "文件 转 PDF",
    convert_upload_file_to_pdf: "上传 Word (.docx) 或 Excel (.xlsx)",
    convert_btn_to_pdf: "转换为 PDF",
    convert_warn_layout: "注意：此转换将提取文本和数据生成 PDF，可能无法保留原始文档的复杂排版和样式。",
  },
  en: {
    app_name: "PDF Master",
    pro_badge: "Pro",
    ...
    convert_desc: "Convert PDF to Word, Excel, or convert files to PDF.",
    convert_upload_label: "Upload PDF to convert",
    convert_note: "Note:",
    convert_note_text: "Excel conversion uses AI for table detection. Results may vary.",
    convert_btn: "Start Conversion",
    convert_processing: "Analyzing & Converting...",
    ...
    edit_header_footer: "Header/Footer",
    ...
    prompt_header: "Enter header text:",
    prompt_footer: "Enter footer text:",
    prompt_text: "Enter text:",
    prompt_link: "Enter URL (e.g., https://example.com):",
    ...
    convert_mode_pdf_to_file: "PDF to File",
    convert_mode_file_to_pdf: "File to PDF",
    convert_upload_file_to_pdf: "Upload Word (.docx) or Excel (.xlsx)",
    convert_btn_to_pdf: "Convert to PDF",
    convert_warn_layout: "Note: This conversion extracts text and data to generate a PDF and may not preserve complex layout and styling.",
  },
  fr: {
    app_name: "PDF Master",
    pro_badge: "Pro",
    ...
    convert_desc: "Convertir PDF en Word, Excel ou convertir des fichiers en PDF.",
    convert_upload_label: "Télécharger PDF à convertir",
    convert_note: "Note :",
    convert_note_text: "La conversion Excel utilise l'IA. Les résultats peuvent varier.",
    convert_btn: "Lancer la conversion",
    convert_processing: "Analyse et conversion...",
    ...
    edit_header_footer: "En-tête/Pied",
    ...
    prompt_header: "Texte de l'en-tête :",
    prompt_footer: "Texte du pied de page :",
    prompt_text: "Saisir le texte :",
    prompt_link: "Saisir URL (ex: https://example.com) :",
    ...
    convert_mode_pdf_to_file: "PDF vers Fichier",
    convert_mode_file_to_pdf: "Fichier vers PDF",
    convert_upload_file_to_pdf: "Télécharger Word (.docx) ou Excel (.xlsx)",
    convert_btn_to_pdf: "Convertir en PDF",
    convert_warn_layout: "Note : Cette conversion extrait le texte et les données pour générer un PDF et peut ne pas conserver la mise en page complexe.",
  },
  es: {
    ...
    convert_title: "Convertir PDF",
    convert_desc: "Convertir PDF a Word, Excel o convertir archivos a PDF.",
    convert_upload_label: "Subir PDF a convertir",
    convert_note: "Nota:",
    convert_note_text: "La conversión a Excel usa IA. Los resultados pueden variar.",
    convert_btn: "Iniciar Conversión",
    convert_processing: "Analizando y Convirtiendo...",
    ...
    edit_tool_link: "Enlace",
    edit_watermark: "Marca de agua",
    edit_header_footer: "Encabezado/Pie",
    ...
    prompt_header: "Texto de encabezado:",
    prompt_footer: "Texto de pie de página:",
    prompt_text: "Introducir texto:",
    prompt_link: "Introducir URL (ej: https://example.com):",
    ...
    convert_mode_pdf_to_file: "PDF a Archivo",
    convert_mode_file_to_pdf: "Archivo a PDF",
    convert_upload_file_to_pdf: "Subir Word (.docx) o Excel (.xlsx)",
    convert_btn_to_pdf: "Convertir a PDF",
    convert_warn_layout: "Nota: Esta conversión extrae texto y datos para generar un PDF y puede no conservar diseños complejos.",
  },
  it: {
    app_name: "PDF Maestro",
    pro_badge: "Pro",
    ...
    convert_title: "Converti PDF",
    convert_desc: "Converti PDF in Word, Excel o converti file in PDF.",
    convert_upload_label: "Carica PDF da convertire",
    convert_note: "Nota:",
    convert_note_text: "La conversione Excel usa l'IA. I risultati possono variare.",
    convert_btn: "Inizia Conversione",
    convert_processing: "Analisi e Conversione...",
    ...
    edit_header_footer: "Intestazione/Piè di pagina",
    ...
    prompt_header: "Testo intestazione:",
    prompt_footer: "Testo piè di pagina:",
    prompt_text: "Inserisci testo:",
    prompt_link: "Inserisci URL (es: https://example.com):",
    ...
    alert_img2pdf_fail: "Conversione fallita.",
    ...
    convert_mode_pdf_to_file: "PDF a File",
    convert_mode_file_to_pdf: "File a PDF",
    convert_upload_file_to_pdf: "Carica Word (.docx) o Excel (.xlsx)",
    convert_btn_to_pdf: "Converti in PDF",
    convert_warn_layout: "Nota: Questa conversione estrae testo e dati per generare un PDF e potrebbe non preservare il layout complesso.",
  }
};
