...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    tool_desc_remove_watermark: "智能识别并清除 PDF 中的文字水印。",
    ...
    wm_title: "PDF 去水印",
    wm_desc: "通过文字匹配智能清除 PDF 中的水印。",
    wm_upload_label: "上传包含水印的 PDF",
    wm_input_label: "输入水印文字",
    wm_input_placeholder: "例如：CONFIDENTIAL, 绝密",
    wm_btn_scan: "自动检测水印",
    wm_btn_remove: "去除水印并下载",
    wm_status_scanning: "正在扫描文档...",
    wm_status_removing: "正在清除...",
    wm_hint: "此工具通过覆盖白色背景来移除文字水印。对于复杂背景或图片水印可能无效。",
    wm_scan_result: "检测到可能的水印文字：",
    wm_no_scan_result: "未检测到明显的倾斜水印文本，请手动输入。",
  },
  en: {
    app_name: "PDF Master",
    pro_badge: "Pro",
    ...
    tool_desc_remove_watermark: "Intelligently identify and cover text watermarks in PDFs.",
    ...
    wm_title: "Remove Watermark",
    wm_desc: "Intelligently remove text watermarks from PDF via text matching.",
    wm_upload_label: "Upload PDF with watermark",
    wm_input_label: "Enter Watermark Text",
    wm_input_placeholder: "e.g., CONFIDENTIAL, DRAFT",
    wm_btn_scan: "Auto Detect",
    wm_btn_remove: "Remove & Download",
    wm_status_scanning: "Scanning document...",
    wm_status_removing: "Removing...",
    wm_hint: "This tool works by covering text watermarks with a white background. It may not work for complex backgrounds or image-based watermarks.",
    wm_scan_result: "Detected potential watermark text:",
    wm_no_scan_result: "No obvious skewed text detected. Please enter manually.",
  },
  fr: {
    app_name: "PDF Master",
    pro_badge: "Pro",
    ...
    remove_watermark: "Effacer Filigrane",
    ...
    tool_desc_remove_watermark: "Identifier et masquer intelligemment les filigranes.",
    ...
    edit_hint: "Astuce : Sélectionnez et appuyez sur Suppr. Glissez les coins pour redimensionar.",
    ...
    wm_title: "Effacer le filigrane",
    wm_desc: "Supprimer intelligemment les filigranes texte.",
    wm_upload_label: "Télécharger PDF avec filigrane",
    wm_input_label: "Texte du filigrane",
    wm_input_placeholder: "ex: CONFIDENTIEL",
    wm_btn_scan: "Détection Auto",
    wm_btn_remove: "Supprimer & Télécharger",
    wm_status_scanning: "Scan du document...",
    wm_status_removing: "Suppression...",
    wm_hint: "Cet outil masque le texte par un fond blanc.",
    wm_scan_result: "Texte détecté :",
    wm_no_scan_result: "Aucun texte incliné détecté.",
  },
  es: {
    ...
    tool_desc_remove_watermark: "Identificar y cubrir inteligentemente marcas de agua de texto.",
    ...
    wm_title: "Quitar Marca de Agua",
    wm_desc: "Elimina inteligentemente marcas de agua de texto.",
    wm_upload_label: "Subir PDF con marca de agua",
    wm_input_label: "Texto de la marca",
    wm_input_placeholder: "ej: CONFIDENCIAL",
    wm_btn_scan: "Auto Detectar",
    wm_btn_remove: "Quitar y Descargar",
    wm_status_scanning: "Escaneando...",
    wm_status_removing: "Eliminando...",
    wm_hint: "Esta herramienta cubre el texto con fondo blanco.",
    wm_scan_result: "Texto detectado:",
    wm_no_scan_result: "No se detectó texto inclinado.",
  },
  it: {
    app_name: "PDF Maestro",
    pro_badge: "Pro",
    ...
    tool_desc_remove_watermark: "Identifica e copri in modo intelligente le filigrane di testo.",
    ...
    wm_title: "Rimuovi Filigrana",
    wm_desc: "Rimuovi intelligentemente le filigrane di testo.",
    wm_upload_label: "Carica PDF con filigrana",
    wm_input_label: "Testo filigrana",
    wm_input_placeholder: "es: RISERVATO",
    wm_btn_scan: "Rilevamento Auto",
    wm_btn_remove: "Rimuovi e Scarica",
    wm_status_scanning: "Scansione...",
    wm_status_removing: "Rimozione...",
    wm_hint: "Questo strumento copre il testo con uno sfondo bianco.",
    wm_scan_result: "Testo rilevato:",
    wm_no_scan_result: "Nessun testo inclinato rilevato.",
  }
};
